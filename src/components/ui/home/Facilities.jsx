...
import Icon1 from "../../../assets/facilities/_fabric.webp"
import Icon2 from "../../../assets/facilities/_return-box.webp"
import Icon3 from "../../../assets/facilities/_free-shipping.webp"
import Icon4 from "../../../assets/facilities/_gift.webp"
import * as motion from "motion/react-client"
import Image from 'next/image';
export default function Facilities () {
    return (
        <div className='max-w-7xl mx-auto grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-5 justify-center py-10 px-5 items-stretch '>
            <motion.div whileHover={{ scale: 1.03 }} className='py-4 hover:bg-base-200 rounded-2xl   shadow px-5 '>
                <Image className='h-12 w-12 ' src={Icon1} alt="fabric" />
            ...
            <motion.div whileHover={{ scale: 1.03 }} className='py-4 hover:bg-base-200  rounded-2xl  shadow px-5 '>
                <Image className='h-12 w-12 ' src={Icon2} alt="return" />
            ...
            <motion.div whileHover={{ scale: 1.03 }} className='py-4 hover:bg-base-200 rounded-2xl  shadow px-5 '> 
                <Image className='h-12 w-12 ' src={Icon3} alt="free shipping" />
            ...
            <motion.div whileHover={{ scale: 1.03 }} className='py-4 hover:bg-base-200 rounded-2xl  shadow px-5 '>
                <Image className='h-12 w-12 ' src={Icon4} alt="gift" />
